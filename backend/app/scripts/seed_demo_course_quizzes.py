...
DEMO_QUIZZES = [
    {
        ...
        "target_role_ids": ["STATISTICAL_OFFICER", "DATA_ANALYST_OFFICER", "EDUCATION_OFFICER"],
        "target_designation_ids": ["Statistical Officer", "Data Analyst", "Senior Statistical Officer (SSO)"],
        "difficulty": "MEDIUM",
        "assignment_type": "ROLE_TARGETED",
        "status": "PUBLISHED",
        "assigned_to": [],
        "questions": [
            {
    ...
    },
    {
        ...
        "target_competency_ids": ["STAT_SAMPLING", "STAT_SURVEY_DESIGN"],
        "target_role_ids": ["STATISTICAL_OFFICER"],
        "target_designation_ids": ["Statistical Officer", "Senior Statistical Officer (SSO)", "Assistant Director (Statistics)"],
        "difficulty": "MEDIUM",
        "assignment_type": "ROLE_TARGETED",
        "status": "PUBLISHED",
        "assigned_to": [],
    ...
    },
    {
        ...
        "target_competency_ids": ["STAT_DATA_QUALITY_FRAMEWORKS"],
        "target_role_ids": ["STATISTICAL_OFFICER", "EDUCATION_OFFICER", "PUBLIC_HEALTH_DATA_OFFICER"],
        "target_designation_ids": ["Statistical Officer", "Education & Curriculum Officer"],
        "difficulty": "MEDIUM",
        "assignment_type": "ROLE_TARGETED",
        "status": "PUBLISHED",
        "assigned_to": [],
    ...
    },
    {
        ...
        "target_competency_ids": ["TECH_PYTHON"],
        "target_role_ids": ["STATISTICAL_OFFICER", "DATA_ANALYST_OFFICER"],
        "target_designation_ids": ["Statistical Officer", "Data Analyst"],
        "difficulty": "MEDIUM",
        "assignment_type": "ROLE_TARGETED",
        "status": "PUBLISHED",
        "assigned_to": [],
    ...
    },
    {
        ...
        "target_competency_ids": ["DIGOV_DIGITAL_PUBLIC_INFRASTRUCTURE", "DIGITAL_GOVERNANCE"],
        "target_role_ids": ["DIGITAL_GOVERNANCE_ARCHITECT", "REVENUE_ADMINISTRATION_OFFICER", "RURAL_DEVELOPMENT_OFFICER", "EDUCATION_OFFICER"],
        "target_designation_ids": ["Informatics Officer / Scientist 'B'", "Technical Director (e-Gov)"],
        "difficulty": "MEDIUM",
        "assignment_type": "ROLE_TARGETED",
        "status": "PUBLISHED",
        "assigned_to": [],
    ...
    },
    {
        ...
        "description": "Comprehensive assessment on village land records, Record of Rights (RoR), 7/12 extract verification, mutation registers, and citizen revenue service delivery.",
        "competency_code": "DIGOV_DIGITAL_PUBLIC_INFRASTRUCTURE",
        "target_competency_ids": ["DIGOV_DIGITAL_PUBLIC_INFRASTRUCTURE", "DIGOV_DIGITAL_SIGNATURES"],
        "target_role_ids": ["REVENUE_ADMINISTRATION_OFFICER", "RURAL_DEVELOPMENT_OFFICER"],
        "target_designation_ids": ["DESIG-REV-TALATHI", "Talathi", "Patwari", "Lekhpal", "Village Revenue Officer (VRO)", "Village Accountant", "Karnam", "Tahsildar", "Naib Tahsildar"],
        "difficulty": "MEDIUM",
        "assignment_type": "ROLE_TARGETED",
        "status": "PUBLISHED",
        "assigned_to": [],
        "questions": [
            {
                "question": "In the standard village land revenue Record of Rights (RoR), what distinct information is recorded in Village Form VII versus Village Form XII (7/12 extract)?",
                "options": [
                    "A. Form VII records village tax rates while Form XII records census figures",
                    "B. Form VII records ownership, occupancy rights, and encumbrances, while Form XII records seasonal crop details, fallow land, and irrigation mode",
                    "C. Form VII is for residential plots while Form XII is strictly for forest land",
                    "D. Form VII and Form XII are identical duplicates",
                ],
                "correct_answer": "B",
                "explanation": "Village Form VII represents the Record of Rights (ownership, tenure, liabilities), while Form XII constitutes the register of crops (Pahani/crop inspection).",
                "difficulty": "EASY",
                "source_chunks": ["chunk-rev-01"],
            },
            {
                "question": "What is the statutory requirement when a mutation entry (Ferfar) is made in the village register upon land transfer or inheritance?",
                "options": [
                    "A. Immediate irreversible transfer without notice",
                    "B. Notice to all interested parties with a statutory window (e.g., 15-30 days) for filing objections before formal certification by the competent revenue officer",
                    "C. Transfer is kept secret until court order",
                    "D. Requires signature of all district residents",
                ],
                "correct_answer": "B",
                "explanation": "State Land Revenue Codes mandate public notice to all interested/affected parties to provide due process before mutation certification.",
                "difficulty": "MEDIUM",
                "source_chunks": ["chunk-rev-02"],
            },
            {
                "question": "How does digital signing of Record of Rights (7/12 extract) under e-Mahabhumi / Bhulekh benefit land administration and citizen verification?",
                "options": [
                    "A. Disables online viewing",
                    "B. Grants legal evidentiary validity under the IT Act with tamper-evident cryptographic QR verification, eliminating manual seal dependency",
                    "C. Increases physical visit requirements to Tehsil offices",
                    "D. Restricts land access to banks only",
                ],
                "correct_answer": "B",
                "explanation": "Digitally signed extracts with verifiable QR codes possess full legal validity and prevent forged offline alterations.",
                "difficulty": "EASY",
                "source_chunks": ["chunk-rev-03"],
            },
            {
                "question": "What is the primary role of the field Talathi / Patwari during digital crop survey (E-Pik Pahani) execution?",
                "options": [
                    "A. Setting market prices for agricultural commodities",
                    "B. Verifying farmer self-reported geotagged crop submissions, conducting sample field checks, and validating uncultivated/fallow land data",
                    "C. Printing physical land certificates only",
                    "D. Purchasing agricultural seeds",
                ],
                "correct_answer": "B",
                "explanation": "Talathis act as authoritative verification officers for mobile app farmer self-declarations and ground-truth sample audits.",
                "difficulty": "MEDIUM",
                "source_chunks": ["chunk-rev-04"],
            },
            {
                "question": "Under standard revenue governance, which authority is empowered to rectify clerical errors in certified land records upon an inquiry report from the Talathi?",
                "options": [
                    "A. Gram Panchayat Member",
                    "B. Tahsildar / Sub-Divisional Officer (SDO) under the State Land Revenue Code",
                    "C. Private Land Surveyor",
                    "D. Commercial Bank Manager",
                ],
                "correct_answer": "B",
                "explanation": "Rectification of clerical or record mistakes requires quasi-judicial order by the Sub-Divisional Officer or Tahsildar under statutory land revenue provisions.",
                "difficulty": "HARD",
                "source_chunks": ["chunk-rev-05"],
            },
        ],
    },
]
...
def sync_demo_quizzes(database: Database) -> None:
    ...
    for quiz_spec in DEMO_QUIZZES:
        ...
        quiz_doc = {
            ...
            "published": True,
            "assigned_to": [],
            "target_competency_ids": quiz_spec.get("target_competency_ids", [comp_code]),
            "target_role_ids": quiz_spec.get("target_role_ids", []),
            "target_designation_ids": quiz_spec.get("target_designation_ids", []),
            "difficulty": quiz_spec.get("difficulty", "MEDIUM"),
